  ...
  <div class>
    <form id="form" class="mt-5" @submit.prevent="signup()" method="post">
      <div class="mx-auto w-50 mb-3">
        <label for="firstName" class="form-label d-flex justify-content-start"
          >Prénom :</label
        >
        <input type="firstName" class="form-control" name="firstName" id="firstName" />
      </div>
      <div class="mx-auto w-50 mb-3">
        <label for="lastName" class="form-label d-flex justify-content-start"
          >Nom :</label
        >
      ...
      <button type="submit" class="btn btn-primary mb-3" @click.prevent="signup">
